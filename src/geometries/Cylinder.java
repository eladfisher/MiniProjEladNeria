...
public class Cylinder extends Tube {
	...
	public Point3D getMinPoint() {
		Point3D h = super.direction.getHead(), t = super.direction.getHead()
				.add(super.direction.getDirection().scale(height));
		double r = super.radius;
		
		//find the min coordinate of all the coordinates of the cylinder
		double x = Math.min((h.getX()), (t.getX())) - r;
		double y = Math.min((h.getY()), (t.getY())) - r;
		double z = Math.min((h.getZ()), (t.getZ())) - r;
	...
	public Point3D getMaxPoint() {
		...
		//find the biggest value for each coordinate for the max point
		double x = Math.max((h.getX()), (t.getX())) + r;
		double y = Math.max((h.getY()), (t.getY())) + r;
		double z = Math.max((h.getZ()), (t.getZ())) + r;
