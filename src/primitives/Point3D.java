...
public class Point3D {
	...
	/**
	 * rotate a point around vector and change it's data
	 *
	 * @param u the vector to rotate the point around him
	 * @param a the degree in radians to rotate the point
	 * @return the same instance of the point rotated
	 */
	...
	/**
	 * rotate a point around vector and return new one
	 *
	 * @param u the vector to rotate the point around him
	 * @param a the degree in radians to rotate the point
	 * @return the new point rotated around the vector
	 */
	 ...
	 * rotate a point around vector and change it's data
	 *
	 * @param r the vector to rotate the point around him
	 * @param a the degree in radians to rotate the point
	 * @return the same instance of the point rotated
	 */
	...
	/**
	 * rotate a point around Ray and return new one
	 *
	 * @param r the ray to rotate the point around him
	 * @param a the degree in radians to rotate the point
	 * @return the new point rotated around the ray
	 */
